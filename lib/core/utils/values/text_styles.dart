...
abstract class TextStyles {
  ...
  static TextStyle regular11({Color? color}) => TextStyle(
    color: color,
    fontSize: 11.sp,
    fontWeight: FontWeight.w400,
    fontFamily: _font,
  ...
  static TextStyle semiBold13({Color? color}) => TextStyle(
    color: color,
    fontSize: 13.sp,
    fontWeight: FontWeight.w600,
    fontFamily: _font,
  ...
  static TextStyle semiBold11({Color? color}) => TextStyle(
    color: color,
    fontSize: 11.sp,
    fontWeight: FontWeight.w600,
    fontFamily: _font,
  ...
  static TextStyle bold9({Color? color}) => TextStyle(
    color: color,
    fontSize: 9.sp,
    fontWeight: FontWeight.w700,
    fontFamily: _font,
  ...
  static TextStyle underlineRegular20({Color? color}) =>
      TextStyle(
        color: color,
        fontSize: 20.sp,
        fontWeight: FontWeight.w400,
