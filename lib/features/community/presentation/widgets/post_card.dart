    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Divider between engagement summary and action buttons (Full width - extends to card edges)
          Divider(
          ...
          IntrinsicHeight(
            child: Row(
              children: [
                ...
                // Vertical Divider between buttons (Full height)
                Container(
                  width: 1,
                  color: MyColors.grey300,
                ),
