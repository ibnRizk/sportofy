...
class MatchBookingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap:
          onTap ??
          () {
            // Verify match object has valid data before navigation
            // (match is required and non-nullable, but validate essential fields)
            if (match.id.isEmpty ||
                match.organizerName.isEmpty) {
              debugPrint(
                'ERROR: Match object has invalid data, cannot navigate to details',
              );
              return;
            }
            ...
            // Use root navigator to ensure proper navigation context
            try {
              Navigator.push(
                context,
                MaterialPageRoute(
                  ...
                  settings: RouteSettings(
                    name: Routes.matchesDetailsRoute,
                    arguments:
                        match, // Pass as arguments for consistency
                  ),
                ),
              );
            } catch (e) {
              debugPrint(
                'Navigation error from match card: $e',
              );
            }
          },
